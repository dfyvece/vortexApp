...
public class WavFile
{
	...
	public String display()
	{
		...
		return new StringBuilder("File: ")
			.append(file).append("\n")
			.append("Channels: ").append(numChannels).append(", Frames: ").append(numFrames).append("\n")
			.append("IO State: ").append(ioState).append("\n")
			.append("Sample Rate: ").append(sampleRate).append(", Block Align: ").append(blockAlign).append("\n")
			.append("Valid Bits: ").append(validBits).append(", Bytes per sample: ").append(bytesPerSample).append("\n")
			.toString();
	}
